...
public class JobController {
    ...
    String simpleBigQuery() throws IOException{
        ...
        try {
            ...
            BigQuery bigquery =  BigQueryOptions.newBuilder()
                ...
                .setProjectId("nimble-perigee-337406")
                .build()
                .getService();
    ...
    String loadFromGcsToBigQuery() throws IOException{
        ...
        String sourceUri = "gs://bucket-nimble-perigee-337406/employee-list.CSV";
    ...
    public List<String> showData() throws Exception{
      // JobParameters jobParameters =
      //                 new JobParametersBuilder()
      //                 .addLong("time",System.currentTimeMillis()).toJobParameters();
      //  jobLauncher.run(job, jobParameters);
    ...
    public List<String> clearData() throws Exception{
      // JobParameters jobParameters =
      //                 new JobParametersBuilder()
      //                 .addLong("time",System.currentTimeMillis()).toJobParameters();
      //  jobLauncher.run(job, jobParameters);

        return this.jdbcTemplate.queryForList("TRUNCATE employee").stream()
				.map((m) -> m.values().toString())
				.collect(Collectors.toList());
    }
    ...
    public String writeFile() throws Exception{
        ...
        try {			
				...
				BlobInfo.newBuilder("bucket-nimble-perigee-337406", hourMinute+"_"+file.getName()).build(), 
